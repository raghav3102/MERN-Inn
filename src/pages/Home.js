...
let goaUrl = 'https://i.pinimg.com/originals/1f/98/f2/1f98f27908696ba7b2c07ec5952dc7ab.jpg';
let goaTitle = 'Goa';
let goaDescription = ' Goa is also known for its beaches, ranging from popular stretches at Baga and Palolem to those in laid-back fishing villages such as Agonda.';

let lehUrl = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3KXCoVrQcAf2OAPhlanTvoLrwBjB7DMQnK8-0PgSKFXPYZoxctip09oVageGkzaEWePQ&usqp=CAU';
let lehTitle = 'Leh-Ladakh';
let lehDescription = 'Ladakh is most famous for breathtaking landscapes, the crystal clear skies, the highest mountain passes, thrilling adventure activities.';


let jaiUrl = 'https://thumbs.dreamstime.com/b/animation-landscape-ancient-indian-city-temples-palaces-dwellings-river-bank-vector-illustration-125911633.jpg';
let jaiTitle = 'Jaisalmer';
let jaiDescription = "Jaisalmer with its royal forts and palaces Jaisalmer's charm lies in its massive sand castles, forts, and colorful bazaars."
function Home() {
  return (<>
    <div className='home'>
    ...
    <div className="homecard d-flex mt-5  mb-5 justify-content-center">
      <Homecard></Homecard>
    </div>
  </>
  );
