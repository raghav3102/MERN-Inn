        ...
        <>
            <div className="container-fluid d-flex justify-content-center">
                ...
                <div className="devcard mx-auto my-auto d-flex align-items-center flex-column p-3 col-md-5 col-sm-8 col-xs-12 text-center">
                    ...
                    <h1 className='mt-4'>Hi, I'm <span className='text-primary'> Vedant Shah! </span></h1>
                    <p>Student and Web Developer</p>
                    <p className='mt-2'>Founder of MERN Inn, aspiring full stack web developer, also a B-Tech Student based in Bangalore, India. You can contact me via my email below, or connect with me via any of my socials.</p>
                    <Button variant="outlined" startIcon={<SiIcons.SiGmail />} >vedantshah2001@gmail.com</Button>
